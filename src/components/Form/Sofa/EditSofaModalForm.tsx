...
export default function RegisterSofaModalForm({ sofaId, sofaType, isSelfOpen, onSelfClose }: RegisterSofaModalFormProps) {
    ...
    return (
        <>
            ...
            >
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader>Editar sofá {sofaType}</ModalHeader>
